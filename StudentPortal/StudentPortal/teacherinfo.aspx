<%@ Page Title="" Language="C#" MasterPageFile="~/Admin2.Master" AutoEventWireup="true" CodeBehind="teacherinfo.aspx.cs" Inherits="StudentPortal.teacherinfo" %>
...
<table style="width: 546px;text-align:center;">
    <tr>
    <td>
        <asp:Label ID="ll1" Text="Name:" runat="server"></asp:Label>
        </td>
         <td>
      ...
      <tr>
    <td>
        <asp:Label ID="Ll2" Text="Department:" runat="server"></asp:Label>
        </td>
         <td>
      ...
      <tr>
    <td>
        <asp:Label ID="Ll3" Text="HomeTown:" runat="server"></asp:Label>
        </td>
         <td>
      ...
      <tr>
    <td>
        <asp:Label ID="Label3" Text="Religion:" runat="server"></asp:Label>
        </td>
         <td>
      ...
      <tr>
    <td>
        <asp:Label ID="Label4" Text="Phone Number:" runat="server"></asp:Label>
        </td>
         <td>
      ...
      <tr>
    <td>
        <asp:Label ID="Label5" Text="Teacher ID:" runat="server"></asp:Label>
        </td>
         <td>
