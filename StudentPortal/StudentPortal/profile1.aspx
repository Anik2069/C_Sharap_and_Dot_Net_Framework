<%@ Page Title="" Language="C#" MasterPageFile="~/Admin2.Master" AutoEventWireup="true" CodeBehind="profile1.aspx.cs" Inherits="StudentPortal.profile1" %>
...
<table style="width: 546px;text-align:center;">
    <tr>
    <td>
        <asp:Label ID="ll1" Text="ID:" runat="server"></asp:Label>
        </td>
         <td>
    ...
    <td>
        <asp:Label ID="Ll2" Text="Name:" runat="server"></asp:Label>
         ...
         <td>
        <asp:TextBox ID="Tb12" runat="server" Height="22px" style="margin-left: 0px" Width="175px"></asp:TextBox>
        </td>
        </tr>
      <tr>
    <td>
        <asp:Label ID="Ll3" Text="Department:" runat="server"></asp:Label>
         ...
         <td>
        <asp:TextBox ID="TextBox2" runat="server" Height="22px" style="margin-left: 0px" Width="175px" OnTextChanged="TextBox2_TextChanged"></asp:TextBox>
    ...
    <td>
      ...
      <tr>
    <td>
        <asp:Label ID="Label4" Text="Birthday:" runat="server"></asp:Label>
        </td>
         <td>
      ...
      <tr>
    <td>
        <asp:Label ID="Label5" Text="Religion:" runat="server"></asp:Label>
        </td>
         <td>
